...
class TestOfFoursquareCrawler extends ThinkUpUnitTestCase {
    ...
    public function setUp() {
        ...
        'url' => 'http://www.fousquare.com/user/113612142759476883204', 'is_post_archive_loaded'=> 1
        );
        // Create an instance with these details
        $this->profile1_instance = new Instance($r);
        // Also insert it into the DB (needed for checking if post archive is loaded)
        $instance_dao = DAOFactory::getDAO('InstanceDAO');
        $instance_dao->insert("113612142759476883204", "aaronkalair@gmail.com", "foursquare", "113612142759476883204");
        $instance_dao->updatePostArchivedLoaded("aaronkalair@gmail.com", "foursquare", "1");
    ...
    // Test going back in time to get old checkins
    public function testFetchInstanceUserCheckinsFullArchive() {
        $builders = self::buildData();

        // Tell ThinkUp we haven't loaded old posts yet
        $instance_dao = DAOFactory::getDAO('InstanceDAO');
        $instance_dao->updatePostArchivedLoaded("aaronkalair@gmail.com", "foursquare", "0");
        ...
        $value = $instance_dao->checkIfOldPostsHaveBeenArchived("aaronkalair@gmail.com", 'foursquare');
